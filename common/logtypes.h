...
LOG_CATEGORY( GROUPSERV )
LOG_TYPE( GROUPSERV, INIT, ENABLED )
LOG_TYPE( GROUPSERV, INIT_ERR, ENABLED )
LOG_TYPE( GROUPSERV, ERROR, ENABLED )
LOG_TYPE( GROUPSERV, CLIENT, DISABLED )
LOG_TYPE( GROUPSERV, TRACE, DISABLED )
LOG_TYPE( GROUPSERV, PACKETS, DISABLED)
